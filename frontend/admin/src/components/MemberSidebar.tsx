...
const memberNavigation = [
  ...
  { name: "Mes Parcelles", href: "/member/plots", icon: MapPin },
  { name: "Mes Tâches", href: "/member/tasks", icon: CheckSquare },
  { name: "Mon Calendrier", href: "/member/calendar", icon: Calendar },
  { name: "Galerie", href: "/member/gallery", icon: Image },
